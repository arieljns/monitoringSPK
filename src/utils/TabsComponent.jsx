...
//permasalahannya adalah saya harus klik tab nya dulu baru keganti currentTab nya
        ...
        <Box sx={{ justifyContent: "center", maxWidth: { xs: 350, sm: 400, lg: 900, }, bgcolor: 'background.paper' }}>
            ...
            >
                {tabsData.map((tab, index) => (
                    <Tab key={index} label={tab.label} onClick={() => { handleTabClick(index) }} disabled={!allow.includes(index)} />
                ))}
            </Tabs>
